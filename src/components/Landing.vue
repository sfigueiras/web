    ...
    <div class="container">
      ...
      <div class="elements">
        ...
        <div class="animation">
          ...
          <div class="unicornio">
            <svg id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 182.46 201.3"
                 height="180px">
              <defs>
                <svg:style>
                  .cls-1 {
              ...
              <path class="cls-1"
                    d="M64.21,170.4a62.25,62.25,0,0,1-4.61,9A55.38,55.38,0,0,1,47,181c-5.5,0-11.5-1-15-5-3.34-3.72-2.55-11.58-.55-19.36.68-2.65,1.5-5.28,2.34-7.74C36.24,141.7,38.94,136,38.94,136s23.34.54,27.75,13.09C69.08,155.88,66.8,164.2,64.21,170.4Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-2"
                    d="M175.4,112.82l-4.55,2.87c-1.31-3.9-2.71-10.35-10.29-13.14-8.81-3.24-13.91,3.3-16.22,7.67l-1.51-.78s.1-.28.3-.75c1.29-3,6.84-13.89,18.13-9.64A24.43,24.43,0,0,1,175.4,112.82Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-3"
                    d="M141.05,108.68s4.64-17.26,19.51-12.88a30.45,30.45,0,0,1,18.19,14.9l-3.35,2.12A24.43,24.43,0,0,0,161.26,99c-11.29-4.25-16.84,6.64-18.13,9.64Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-2"
                    d="M153.79,93.58c18.34-2.51,27.36,15.61,27.36,15.61l-2.4,1.51a30.45,30.45,0,0,0-18.19-14.9c-14.87-4.38-19.51,12.88-19.51,12.88l-.94-.1C140.74,102.27,143.71,95,153.79,93.58Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-3"
                    d="M144.34,110.22c2.31-4.37,7.41-10.91,16.22-7.67,7.58,2.79,9,9.24,10.29,13.14l-3.91,2.47s-.89-10.64-9.08-12.28c-14.31-2.86-13.53,13-13.53,13l-3.68-.69a30.14,30.14,0,0,1-.59-4.32l2.77-.22a22.69,22.69,0,0,1,1.16-2.79Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-4"
                    d="M144,110.91a22.69,22.69,0,0,0-1.16,2.79l-2.77.22a32,32,0,0,1,.05-5.34l.94.1h2.08c-.2.47-.3.75-.3.75l1.51.78Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-5"
                    d="M140.11,108.58c.63-6.31,3.6-13.62,13.68-15,18.34-2.51,27.36,15.61,27.36,15.61l-2.4,1.51-3.35,2.12-4.55,2.87-3.91,2.47s-.89-10.64-9.08-12.28c-14.31-2.86-13.53,13-13.53,13"
                    transform="translate(0.66 0.33)"/>
              ...
              <path class="cls-5" d="M178.75,110.7a30.45,30.45,0,0,0-18.19-14.9c-14.87-4.38-19.51,12.88-19.51,12.88"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-6"
                    d="M81.69,95.9c37.78-1.46,76.66,14.08,76.61,23.35-.06,11.44.55,28.59-41.18,49.28l-.74.37A60.79,60.79,0,0,1,103,173.66C66.89,182,33,154.76,29.92,141.6A18.06,18.06,0,0,0,28.68,138"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-7"
                    d="M117.12,168.53l-.74.37A60.79,60.79,0,0,1,103,173.66l-5.44-24.58S108,154.35,117.12,168.53Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-1"
                    d="M75.68,155.81c-2.15,8-9.47,39.1,1.72,42.85s26.28,1.61,30.15-5.89-.09-38.64-5.86-43.69S75.68,155.81,75.68,155.81Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-6" d="M28.68,138S21,95.22,42,71.8" transform="translate(0.66 0.33)"/>
              <polyline class="cls-8"
                        points="38.12 79.91 34.22 102.24 29.34 134.31 30.35 140 67.19 128.61 80.23 101.34 60.6 74.06"/>
              <path class="cls-6"
                    d="M86.36,119.25s3.61-23.42-4.66-45-13.7-41.91-47-33.9S-1.16,63.78.07,71.8s37.59,21,54.85,7.12"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-3"
                    d="M47.69,36.14c.62,2.8.86,4.75.46,5.25-2.18,2.76-8.48,4-10.5,2a3.49,3.49,0,0,1-.51-1.53A25,25,0,0,0,47.69,36.14Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-9"
                    d="M46,29.64c.69,2.42,1.28,4.65,1.7,6.5a25,25,0,0,1-10.55,5.74,61.64,61.64,0,0,1-.69-6.64A25.39,25.39,0,0,0,46,29.64Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-3"
                    d="M44.22,23.8c.64,2,1.23,4,1.77,5.84a25.39,25.39,0,0,1-9.54,5.6c-.13-2-.24-4.22-.33-6.59A25,25,0,0,0,44.22,23.8Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-9"
                    d="M42.38,18.07C43,20,43.63,21.9,44.22,23.8a25,25,0,0,1-8.1,4.85C36,26.5,36,24.25,35.91,22A25.34,25.34,0,0,0,42.38,18.07Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-3"
                    d="M40.93,13.75c.48,1.4,1,2.85,1.45,4.32A25.34,25.34,0,0,1,35.91,22c0-1.93-.09-3.87-.12-5.75A24.43,24.43,0,0,0,40.93,13.75Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-9"
                    d="M39.11,8.53c.58,1.62,1.19,3.38,1.82,5.22a24.43,24.43,0,0,1-5.14,2.49c0-2.19-.07-4.3-.09-6.24A23.86,23.86,0,0,0,39.11,8.53Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-3"
                    d="M36,.29c.61,1.42,1.75,4.44,3.09,8.24A23.86,23.86,0,0,1,35.7,10c-.06-4.41-.07-8-.08-9.63A.21.21,0,0,1,36,.29Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-5"
                    d="M39.11,8.53C37.77,4.73,36.63,1.71,36,.29a.21.21,0,0,0-.4.08c0,1.66,0,5.22.08,9.63,0,1.94.05,4,.09,6.24,0,1.88.07,3.82.12,5.75.06,2.26.13,4.51.21,6.66.09,2.37.2,4.6.33,6.59a61.64,61.64,0,0,0,.69,6.64,3.49,3.49,0,0,0,.51,1.53c2,2,8.32.74,10.5-2,.4-.5.16-2.45-.46-5.25-.42-1.85-1-4.08-1.7-6.5-.54-1.85-1.13-3.83-1.77-5.84S43,20,42.38,18.07c-.48-1.47-1-2.92-1.45-4.32C40.3,11.91,39.69,10.15,39.11,8.53Z"
                    transform="translate(0.66 0.33)"/>
              ...
              <path class="cls-1"
                    d="M137.29,149.08c-1.08,5.05-8.23,32.08-1.87,34.47s18.84,2,21.35-6,4.89-28.22-1.87-36.17S137.29,149.08,137.29,149.08Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-10" d="M43,56.23a1.5,1.5,0,0,0,0-3,1.5,1.5,0,0,0,0,3Z" transform="translate(0.66 0.33)"/>
              <path class="cls-10" d="M24.17,50.47a1.5,1.5,0,0,0,0-3,1.5,1.5,0,0,0,0,3Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-7"
                    d="M64.21,170.4a62.25,62.25,0,0,1-4.61,9A55.38,55.38,0,0,1,47,181c-6.93-8.26-12.49-18.23-15.59-24.34.68-2.65,1.5-5.28,2.34-7.74C39.38,156.41,50.44,165.13,64.21,170.4Z"
                    transform="translate(0.66 0.33)"/>
              <path class="cls-7"
                    d="M49.25,82.31a120,120,0,0,1-13.1,18.54c-2.47,2.9-5.26,5.91-8.4,8.94.13-1.57.31-3.17.53-4.79.07-.52.15-1,.23-1.57s.16-1.06.26-1.59q.42-2.53,1-5.09c.11-.43.21-.86.32-1.29.37-1.45.78-2.89,1.24-4.33q.24-.77.51-1.53c.14-.4.28-.8.43-1.2q.38-1,.78-2L33.64,85a43.54,43.54,0,0,0,5.73-.25A34.2,34.2,0,0,0,49.25,82.31Z"
                    transform="translate(0.66 0.33)"/>
            </svg>
          </div>
          <div class="soga">
